...
public interface ICustomInventory {
    ...
    default void backItem(int slot, Inventory previous) {
        backItem(slot, (InventoryClickEvent event) -> {
    ...
    default void onRegroupItem(InventoryRegroupItemEvent event) {
    }
    ...
    public static interface ConsumerClickListener extends ClickListener, Consumer<InventoryClickEvent> {

    }

    public static interface RunnableClickListener extends ClickListener, Runnable {
