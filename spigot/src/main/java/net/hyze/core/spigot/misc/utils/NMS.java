...
public class NMS {
     ...
     * @return Retorna uma instancia de customEntityClass já spawnada no mundo
     */
    public static <T extends Entity> T spawnCustomEntity(Class<T> customEntityClass, Class<? extends Entity> entityClass, Location location, Consumer<net.minecraft.server.v1_8_R3.Entity> preSpawn) {
        try {
