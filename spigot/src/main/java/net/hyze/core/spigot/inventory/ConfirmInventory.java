...
public class ConfirmInventory {
    ...
    public CustomInventory make(String... acceptDescription) {
        return new ConfirmInventory.Inventory(onAccept, onDeny, icon, createTime, acceptDescription);
    }
    ...
    public static class Inventory extends CustomInventory {
        ...
        private void buildInventory() {
            ...
            getRawInventory().setItem(icon == null ? 11 : 20, accept.make(), (InventoryClickEvent event) -> {
            ...
            getRawInventory().setItem(icon == null ? 15 : 24, deny.make(), (InventoryClickEvent event) -> {
                Player player = (Player) event.getWhoClicked();
                player.closeInventory();
                CustomSound.BAD.play(player);
                onDeny(event);
            ...
            if (icon != null) {
                getRawInventory().setItem(13, icon.clone());
            }
        }
