 ...
 */
package net.hyze.core.spigot.misc.scoreboard.protocol.packetwrapper;
...
public class WrapperPlayServerScoreboardTeam extends AbstractPacket {
     ...
     * Retrieve Players.
     * <p>
     * Notes: only if Mode = 0 or 3 or 4. Players to be added/remove from the team. Max 40 characters so may
     * be uuid's later
     *
     ...
     * Retrieve Mode.
     * <p>
     * Notes: if 0 then the team is created. If 1 then the team is removed. If 2 the team team information is
     * updated. If 3 then new players are added to the team. If 4 then players are removed from the team.
     *
