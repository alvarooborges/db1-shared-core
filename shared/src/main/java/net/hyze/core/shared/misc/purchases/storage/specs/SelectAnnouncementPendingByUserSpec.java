...
public class SelectAnnouncementPendingByUserSpec extends SelectSqlSpec<List<Purchase>> {
    ...
    public PreparedStatementCreator getPreparedStatementCreator() {
        return connection -> {
            ...
            String query = "SELECT * FROM `purchases` WHERE `user_id` = ? AND `activation_state` = 'COMPLETE' AND `announcement_state` = ?;";
